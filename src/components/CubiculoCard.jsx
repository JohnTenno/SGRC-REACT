...
export function CubiculoCard({
  ...
  return (
    <button
      ...
      className={`relative flex h-[25rem] w-full flex-col overflow-hidden rounded-lg border-2 bg-white text-left shadow-md transition ${
        selected
    ...
    >
      <div className="relative h-40 w-full shrink-0 overflow-hidden bg-uach-purple-950">
        <img
          src={image}
          alt={imageAlt}
          loading="lazy"
      ...
      <div className="flex min-h-0 flex-1 flex-col p-5">
        <h3 className="font-alverata line-clamp-2 text-lg font-semibold text-uach-purple-900">
          {name}
        </h3>
        <p className="font-praxis mt-2 line-clamp-3 flex-1 text-sm leading-relaxed text-uach-purple-900/75">
          {description}
        </p>
        <p className="font-praxis mt-3 shrink-0 text-sm font-medium text-uach-purple-900">
          Capacidad máxima:{' '}
