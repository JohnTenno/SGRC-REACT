...
import { MyReservationCard } from '@/app/components/cubicles/MyReservationCard'
import { fetchMyCubicleReservations } from '@/app/services/cubicles/reservation.service'
import { splitReservationsByTimeline } from '@/app/utilities/timeline'
  ...
  useEffect(() => {
    async function load() {
      ...
      try {
        ...
        setErrorMessage(error?.message ?? 'No se pudieron cargar tus reservas. Intenta de nuevo.')
      } finally {
        setIsLoading(false)
      }
    }
