...
import { formatRemainingTime } from '@/app/utilities/timeline'
...
export function ReservationCountdown({
  ...
  return (
    ...
    >
      <p
        className={`font-praxis text-xs font-medium ${variant === 'usage' ? 'text-uach-purple-900/70' : 'text-amber-900/80'
          }`}
      >
        {label}
      </p>
      <p
        className={`font-alverata mt-1 text-3xl font-semibold tracking-tight tabular-nums ${expired
