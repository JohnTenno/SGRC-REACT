...
import { ReservationCalendar } from '@/app/components/cubicles/ReservationCalendar'
...
function validateForm({ reservationDate, startTime, endTime, minDate, maxDate, occupiedSlots }) {
  const errors = {}
