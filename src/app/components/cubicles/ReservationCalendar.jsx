...
import { IconChevron } from '@/app/components/common/icons'
        ...
        {cells.map((cell, index) =>
          cell === null ? (
            ...
            <button
              ...
              className={`font-alverata aspect-square w-full rounded-lg text-sm font-medium transition ${cell.selected
