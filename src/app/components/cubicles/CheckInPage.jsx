...
import { CheckInWelcomeAnimation } from '@/app/components/common/animations/CheckInWelcomeAnimation'
...
import { fetchMyCubicleReservations, performCubicleCheckIn } from '@/app/services/cubicles/reservation.service'
import {
  canPerformCheckIn,
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        ...
        setLoadError(error?.message ?? 'No se pudo cargar la reserva.')
      } finally {
        setIsLoading(false)
      }
    }
