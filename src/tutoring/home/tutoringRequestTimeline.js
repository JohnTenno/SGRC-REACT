import { TUTORING_REQUEST_STATUS } from '@/data/mockTutoringRequests'
...
export function splitTutoringRequests(requests, now = Date.now()) {
  ...
  for (const request of requests) {
    ...
    if (
      request.status === TUTORING_REQUEST_STATUS.PENDING_PROFESSOR &&
      upcomingSession
    ) {
